...
main_df <- as.data.frame(read_csv("metagenomics_data/PROKKA/class_abundance.csv"))
...
make_class_plot <- function(gene_name, main_df){
  ...
  # and now make a plot 
  pl <- ggplot(data = df, aes(x = reorder(class, abundance), y = abundance, fill = class)) + 
    geom_bar(stat = "identity") + 
    scale_fill_manual(values=c("#e6a0c4", "#c6cdf7", "#d8a499")) +
...
figure_path <- paste("../FINAL_PROJ/figures/SUPP/NapA_plot.pdf", sep = "/")
NapA_plot
ggsave(figure_path, width = fig_height, height = fig_width, units = "cm")

figure_path <- paste("../FINAL_PROJ/figures/SUPP/NifD_plot.pdf", sep = "/")
NifD_plot
ggsave(figure_path, width = fig_height, height = fig_width, units = "cm")

figure_path <- paste("../FINAL_PROJ/figures/SUPP/NirK_plot.pdf", sep = "/")
NirK_plot
ggsave(figure_path, width = fig_height, height = fig_width, units = "cm")

figure_path <- paste("../FINAL_PROJ/figures/SUPP/NirS_plot.pdf", sep = "/")
NirS_plot
ggsave(figure_path, width = fig_height, height = fig_width, units = "cm")

figure_path <- paste("../FINAL_PROJ/figures/SUPP/NorB_plot.pdf", sep = "/")
NorB_plot
ggsave(figure_path, width = fig_height, height = fig_width, units = "cm")

figure_path <- paste("../FINAL_PROJ/figures/SUPP/NorC_plot.pdf", sep = "/")
NorC_plot
ggsave(figure_path, width = fig_height, height = fig_width, units = "cm")

figure_path <- paste("../FINAL_PROJ/figures/SUPP/NosZ_plot.pdf", sep = "/")
NosZ_plot
ggsave(figure_path, width = fig_height, height = fig_width, units = "cm")

figure_path <- paste("../FINAL_PROJ/figures/SUPP/NxrA_plot.pdf", sep = "/")
NxrA_plot
ggsave(figure_path, width = fig_height, height = fig_width, units = "cm")

figure_path <- paste("../FINAL_PROJ/figures/SUPP/NxrB_plot.pdf", sep = "/")
NxrB_plot
ggsave(figure_path, width = fig_height, height = fig_width, units = "cm")
